...
//mImageCaptureUri = Uri.fromFile(new File(Environment.getExternalStorageDirectory(),"tmp_contact_" + String.valueOf(System.currentTimeMillis()) + ".jpg"));
        mImageCaptureUri = Uri.fromFile(new File(Sdcard.getFileDir(),"sprites/face/default/0.png"));		
...
mImageCaptureUri = Uri.fromFile(new File(Sdcard.getFileDir(),"sprites/face/default/facedetect" + String.valueOf(System.currentTimeMillis()) + ".png"));		
