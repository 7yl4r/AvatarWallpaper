...
public class Layer_DebugInfo {
    ...
    public static void drawFPS(Canvas c, float desiredFPS, Rect frame,Avatar avtr, Context ctx){
    	...
    	yOffset+=newLine;
    	c.drawText("BehavSel:" + avtr.getBehaviorSelectorMethod(ctx),xOffset,yOffset,mPaint);
    }
